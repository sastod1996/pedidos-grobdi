...
Route::prefix('bonificaciones')->group(function () {
    ...
    Route::get('/metas/details/{visitorGoalId}', [MetasController::class, 'getDataForChartByVisitorGoal'])->name('visitadoras.metas.details');
    ...
    Route::get('/metas/visitadora', [VisitorGoalController::class, 'showLogged'])->name('visitadoras.metas.show.logged');
